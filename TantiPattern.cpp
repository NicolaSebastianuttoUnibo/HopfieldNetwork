...
void TantiPattern::TantiPattern::creaMatrice(){
    ...
    for(int i=0;i<TantiPattern::TantiPattern::patterns_.size();i++){
        allmyvectors.push_back(TantiPattern::TantiPattern::patterns_[i].getPatternQ());
    }
...
void TantiPattern::TantiPattern::disicorrompi(int index){
    // std::vector<int> a;
    TantiPattern::TantiPattern::h_.disicorrompi(TantiPattern::TantiPattern::patterns_[index].getPatternD());
...
void TantiPattern::TantiPattern::removePattern(int index){
    ...
    TantiPattern::TantiPattern::patterns_.erase(TantiPattern::TantiPattern::patterns_.begin() + index);
    }
}
