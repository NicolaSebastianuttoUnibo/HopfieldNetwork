...
TEST_SUITE("TrainingPattern") {
  ...
  TEST_CASE("TrainingImagePattern") {
    ...
    std::vector<float> avg_lums_3x2 = {0.0f,   128.0f, 255.0f, 255.0f,
                                       128.0f, 0.0f}; // Directly from image
    ...
    std::vector<float> avg_lums_3x1 = {127.5f, 180.0f,
                                       127.5f}; /// calculated manually
    ...
    std::vector<float> avg_lums_1x2 = {127.66666f,
                                       127.66666f}; /// calculated manually
    ...
    CHECK_THROWS_AS(
        TP::ImageTrainingPattern<int>("non_existent_image.png", 1, 1),
        std::runtime_error);
